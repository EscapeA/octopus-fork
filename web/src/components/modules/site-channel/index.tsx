    ...
    return (
        <>
            ...
            >
                <TableHeader>
                    <TableRow>
                        <TableHead className={cn(STICKY_HEAD_CELL, 'w-10 px-3')}>
                            <SelectionCheckbox
                ...
                <TableBody>
                    {models.map((model) => {
                        ...
                        return (
                            ...
                            >
                                <TableCell className={cn('px-3', compactMode ? 'py-2' : undefined)}>
                                    <SelectionCheckbox
                                        checked={isSelected}
                                        disabled={isPending}
                                ...
                                <TableCell className={cn('min-w-0', compactMode ? 'py-2' : undefined)}>
                                    <div className="truncate text-sm">{model.group_name || model.group_key}</div>
                                </TableCell>
                                <TableCell className={cn('min-w-0', compactMode ? 'py-2' : undefined)}>
                                ...
                                <TableCell className={cn('min-w-0 text-right', compactMode ? 'py-2' : undefined)}>
...
function SiteCardImpl({
    ...
    return (
        <MorphingDialog disableSharedLayout>
            <div
