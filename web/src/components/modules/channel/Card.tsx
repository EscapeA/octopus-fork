    ...
    if (isCompactLayout) {
        ...
        return (
            <MorphingDialog>
                ...
                <MorphingDialogContainer>
                    <MorphingDialogContent className="relative flex max-h-[calc(100dvh-env(safe-area-inset-top,0px)-0.5rem)] min-h-0 w-[min(100vw-0.5rem,64rem)] max-w-full flex-col overflow-hidden rounded-t-2xl border border-border bg-card px-4 pt-4 pb-[calc(1rem+env(safe-area-inset-bottom,0px))] text-card-foreground sm:rounded-xl md:max-h-[calc(100dvh-2rem)] md:w-[min(100vw-1rem,64rem)] md:px-6 md:py-5">
