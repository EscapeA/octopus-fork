...
func DefaultSettings() []Setting {
	return []Setting{
		...
		{Key: SettingKeyNavOrder, Value: `["home","hub","checkin","credential","channel","group","model","analytics","log","alert","ops","apikey","setting","user"]`},
		{Key: SettingKeyNavVisible, Value: `["home","hub","checkin","credential","channel","group","model","analytics","log","alert","ops","apikey","setting","user"]`},
